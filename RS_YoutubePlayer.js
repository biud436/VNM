...
(function() {
  ...
  // YTPlayer.playYoutube("https://youtu.be/xRbPAVnqtcs");
  ...
  var Component_PlayingYoutubeGameScene, 
  ...
  Component_PlayingYoutubeGameScene = (function(superClass) {
    extend(Component_PlayingYoutubeGameScene, superClass);

    function Component_PlayingYoutubeGameScene() {
      Component_PlayingYoutubeGameScene.__super__.constructor.call(this);
    };
    
    Component_PlayingYoutubeGameScene.prototype.initialize = function() {
      Component_PlayingYoutubeGameScene.__super__.initialize.apply(this, arguments);
    };
  
    Component_PlayingYoutubeGameScene.prototype.playYoutubeVideo = function(src) {
      var w = $PARAMS.resolution.width || 800;
    ...
    Component_PlayingYoutubeGameScene.prototype.prepareVisual = function() {
      ...
      return Component_PlayingYoutubeGameScene.__super__.prepareVisual.apply(this, arguments);
    };
  
    Component_PlayingYoutubeGameScene.prototype.updateContent = function() {
      Component_PlayingYoutubeGameScene.__super__.updateContent.apply(this, arguments);      
      this.checkEscapeToYoutube();
    };
  
    Component_PlayingYoutubeGameScene.prototype.checkEscapeToYoutube = function() {

      var x = Input.Mouse.x || 0;
      var y = Input.Mouse.y || 0;
    ...
    Component_PlayingYoutubeGameScene.prototype.dispose = function() {
      YTPlayer.removeAllElement();
      console.log("유튜브 플레이어 제거 완료");
      return Component_PlayingYoutubeGameScene.__super__.dispose.apply(this, arguments);
    };  

    return Component_PlayingYoutubeGameScene;
  
  })(vn.Component_GameSceneBehavior);

  window.Component_PlayingYoutubeGameScene = Component_PlayingYoutubeGameScene;
  ...
  Component_CommandInterpreterForYoutube = (function(superClass) {
    extend(Component_CommandInterpreterForYoutube, superClass);

    function Component_CommandInterpreterForYoutube() {
      Component_CommandInterpreterForYoutube.__super__.constructor.call(this);
    };

    Component_CommandInterpreterForYoutube.prototype.initialize = function() {
      Component_CommandInterpreterForYoutube.__super__.initialize.apply(this, arguments);    
    };

    Component_CommandInterpreterForYoutube.prototype.assignCommand = function(command) {
      switch (command.id) {
        case "gs.PlayYoutubeVideo":
          return command.execute = this.commandYoutubeVideo;
      };    
      return Component_CommandInterpreterForYoutube.__super__.assignCommand.apply(this, arguments);   
    };
  
    Component_CommandInterpreterForYoutube.prototype.commandYoutubeVideo = function() {
      var ref, scene;
    ...
    return Component_CommandInterpreterForYoutube;

  })(gs.Component_CommandInterpreter);

  window.Component_CommandInterpreterForYoutube = Component_CommandInterpreterForYoutube;
